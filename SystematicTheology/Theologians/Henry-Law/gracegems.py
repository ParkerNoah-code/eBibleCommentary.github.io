...
url = 'https://www.gracegems.org/LAW/Psalms.htm'
author = 'Psalms Commentary'
title = 'The Gospel in Psalms'
file_name = 'gospel-in-psalms'
...
create_files(file_name, author, title, urls_titles)